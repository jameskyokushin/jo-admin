 ...
 action_item :only => :show do
  ...
  form do |f|
    ...
    f.inputs "Job Order" do
     ...
     f.input :technical1, :label => "Team Leader", :collection => [["Brian Flores","BRIAN FLORES"],["Excel Abejuela","EXCEL ABEJUELA"],["Armas Melvin","ARMAS MELVIN"],["Alinsoot Alberto","ALINSOOT ALBERTO"],["Tan Edwin","TAN EDWIN"],["Borres Stephene","BORRES STEPHENE"],["Dumale Adrian","DUMALE ADRIAN"],["Ebo Alpin","EBO ALPIN"],["Babaylo Herbert","BABAYLO HERBERT"],["Calzada Roel","CALZADA ROEL"],["Lapasaran Arvin","LAPASARAN ARVIN"],["Ruiz Dani Lee","RUIZ DANI LEE"],["Sangrador Allan","SANGRADOR ALLAN"],["Sarco Estelito","SARCO ESTELITO"],["Payot Nizan"],["Ungui Jenny","UNGUI JENNY"],["Compra Honey Mae","COMPRA HONEY MAE"],["Turpias Felix","TURPIAS FELIX"],["Managase Junryll","MANAGASE JUNRYLL"],["Natividad Allen","NATIVIDAD ALLEN"],["Lemuel Ibo","LEMUEL IBO"],["Rodado Joshua","RODADO JOSHUA"],["Quintana Mirro","QUINTANA MIRROO"],["Templado Eleazar","TEMPLADO ELEAZAR"],["Viajar Romy","VIAJAR ROMY"],["Villaflor Edison","VILLAFLOR EDISON"],["Anciano Ronilo","ANCIANO RONILLO"],["Dumaya Elzy","DUMAYA ELZY"],["Jamolin Lyka","JAMOLIN LYKA"],["Morena Apollo","MORENA APOLLO"],["Rodado Jahaziel","Rodado Jahaziel"],["Sinda Mark Nemesis","SINDA MARK NEMESIS"],["Metchil Balili","METCHIL BALILI"],["Nowel Roble","NOWEL ROBLE"],["Hermino Decretales","HERMINIO DECRETALES"]] 
